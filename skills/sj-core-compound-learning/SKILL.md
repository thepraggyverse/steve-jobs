...
description: "Capture reusable Jobs-derived lessons after each use. Use when turning a completed analysis, project, review, launch, or failure into reusable Steve Jobs operating knowledge for future skills or references."
---
...
Capture reusable Jobs-derived lessons after each use.
